...
import 'package:dating_app/pages/swipe_page_1.dart';
import 'package:dating_app/widgets/profile_card_0.dart';
...
class _SwipePageState extends State<SwipePage> {
                      ...
                      (index) => Padding(
                        ...
                        child: IconButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const SwipePage1()),
                            );
                          },
                          icon: Icon(
  ...
  void _loadCards() {
    for (String image in images) {
      profile.add(ProfileCard0(image: image));
    }
  }
}