...
import 'package:dating_app/widgets/profile_card_1.dart';
import 'package:flutter/material.dart';
import 'offer_page.dart'; 


class SwipePage1 extends StatefulWidget {
  const SwipePage1({Key? key}) : super(key: key);

  @override
  State<SwipePage1> createState() => _SwipePageState();
}

class _SwipePageState extends State<SwipePage1> {
  List<ProfileCard1> profile = [];
                      ...
                      (index) => Padding(
                        ...
                        child: IconButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const SwipePage2()),
                            );
                          },
                          icon: Icon(
  ...
  void _loadCards() {
    for (String image in images) {
      profile.add(ProfileCard1(image: image));
    }
  }
}