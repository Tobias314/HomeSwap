...
class SwipePage3 extends StatefulWidget {
  const SwipePage3({Key? key}) : super(key: key);

  @override
  State<SwipePage3> createState() => _SwipePage3State();
}

class _SwipePage3State extends State<SwipePage3> {
  List<ProfileCard3> profile = [];

  List<String> images = [
    'assets/images/tauschwohnung09.jpg',
  ];
  ...
  void _loadCards() {
    for (String image in images) {
      profile.add(ProfileCard3(image: image));
    }
  }
}