import 'package:dating_app/pages/swipe_page_3.dart';
import 'package:flutter/material.dart';
import 'package:dating_app/constants/colors.dart';
import 'offer_page.dart'; 

class UserInfoPage2 extends StatefulWidget {
  UserInfoPage2({Key? key, required this.image}) : super(key: key);
  final String image;
...
class _UserInfoPage2State extends State<UserInfoPage2> {
  List<String> images = [
    'assets/images/tauschwohnung08.jpg',
  ];
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Text('Wohnung in Berlin Spandau, 42 m²',
                            style: TextStyle(
                                fontSize: 24,
                      ...
                      (index) => Padding(
                        ...
                        child: IconButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => SwipePage3()),
                            );
                          },
                          icon: Icon(
