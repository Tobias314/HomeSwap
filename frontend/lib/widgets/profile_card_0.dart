...
import 'package:dating_app/pages/user_info_page_0.dart';
import 'package:flutter/material.dart';

class ProfileCard0 extends StatelessWidget {
  const ProfileCard0({Key? key, required this.image}) : super(key: key);
  final String image;
