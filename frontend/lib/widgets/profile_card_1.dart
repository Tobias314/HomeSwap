...
import '../pages/user_info_page_1.dart';

class ProfileCard1 extends StatelessWidget {
  const ProfileCard1({Key? key, required this.image}) : super(key: key);
  final String image;
        ...
        children: [
          InkWell(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder:  (context) => UserInfoPage1(image: image))
              );
            },
            child: Container(
              decoration: BoxDecoration(
